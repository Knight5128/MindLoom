...
| 项 | 内容 | Commit |
| --- | --- | --- |
| B4 | 打字机模式（光标行垂直居中） | `e76f5b0` |
| B5 | 打字即静默（隐藏鼠标指针与全部 UI） | `856dc27` |
| B6 | 「烛光」暖色主题 | `705cec3` |
| B7 | 全屏 + 字号 / 行宽调节 | `5943561` |
| C8 | 「晚安」收笔仪式 | `baf0b80` |
| C9 | 时间感知问候语 + 轮换 placeholder | `92a4a37` |
| C10 | 助眠定时器（环境音渐弱停止） | `97cc23d` |
| D11 | 场景预设（一键背景 + 音效） | `7664b75` |
| D12 | 呼吸环与钵音对齐 + 秒数倒计时 | `c509901` |
| D13 | 减弱动态 + 侧栏搜索 + 导出命名修正 | `200528c` |
